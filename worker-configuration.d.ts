/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8caf556da0a0cf1d48d784b245b08375)
// Runtime types generated with workerd@1.20260811.1 2026-08-01 nodejs_compat
interface __BaseEnv_Env {
	FARM: DurableObjectNamespace<import("./src/server/worker").FarmDurableObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server/worker");
		durableNamespaces: "FarmDurableObject";
	}
